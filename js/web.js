...
function createfonts() {
	...
	if ($("#textuser").val() == "") {
		...
		for (var i = 0; i < 28; i++) {
			var valor = Math.floor((Math.random() * 3) + 2);
			$("#herefonts").append("<a href='" + a[i] + "' target='_blank'><div class='kol-" + valor + " textmedium' style='font-family:fuente" + i + "'><div class='kol-90 centerkol whereisthefont'>Example text, lorem ipsum em tore ipsum lorem ipsum em tore ipsum lorem ipsum em tore ipsum lorem ipsum em tore ipsum</div></div></a>")
		}
	}
}
